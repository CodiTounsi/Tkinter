...
stone_image1 = Image.open("assets\\stone.png")
stone_image = ImageTk.PhotoImage(stone_image1)

paper_image1 = Image.open("assets\\paper.png")
paper_image = ImageTk.PhotoImage(paper_image1)

scissors_image1 = Image.open("assets\\scissors.png")
...
msg2 = Label(
  win, text=' You ', font=("Courier", 8), relief=GROOVE)
msg2.place(relx=0.3, rely=0.79, anchor=CENTER)

msg3 = Label(
  win, text=' Com ', font=("Courier", 8), relief=GROOVE)
msg3.place(relx=0.7, rely=0.79, anchor=CENTER)

msg4 = Label(
  win, text=' Score Board ', font=("Courier", 18), relief=GROOVE)
